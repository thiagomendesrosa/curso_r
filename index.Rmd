...
- Devido aos itens anteriores, a reprodutibilidade de alguns scripts podem ficar comprometida. Guardar informações da sessão em que o código foi executado pode mitigar essa situação (versão do R e dos pacotes utilizado). O gerenciamento centralizado do RStudio Server, por exemplo, contribui para minimizar esse tipo de ocorrência.
...
- Pesquisas 156;
- Base de MEIs;
- Dados de Sindrome Respiratória Aguda Grave -- Saíde;
...
É possível fazer o download dos arquivos diretamente pelo R seguindo os passos abaixo.
...
```{r, eval=FALSE}
library(readr)
pdad_2018_moradores <- read_csv("http://www.codeplan.df.gov.br/wp-content/uploads/2020/06/mor2018_31ras.csv", 
